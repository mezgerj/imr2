...
namespace Inspinia_MVC5.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Description,Application_Id,Start_Date,End_Date")] Event events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Event([Bind(Include = "ID,Title,Description,Application_Id,Start_Date,End_Date")] Event Event)
        {
            if (ModelState.IsValid)
            {
