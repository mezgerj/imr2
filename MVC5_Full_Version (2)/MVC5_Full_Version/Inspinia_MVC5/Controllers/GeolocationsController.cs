...
namespace Inspinia_MVC5.Controllers
{
    public class GeolocationsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="GeolocationID,Name,Latitude,Longitude,Altitude,Description,Application_Id,Parent_Geo_Id,Range,DownloadTime")] Geolocation geolocation)
        {
            if (ModelState.IsValid)
            {
